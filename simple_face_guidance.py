"""
Simplified Face Recognition App using OpenCV
This version uses OpenCV's Haar cascades for face detection to avoid DeepFace complexity
"""
import cv2
import time
